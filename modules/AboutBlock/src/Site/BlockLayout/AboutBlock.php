<?php
namespace AboutBlock\Site\BlockLayout;
 ...
 */
class AboutBlock extends AbstractBlockLayout
{
    /**
    ...
    {
        return 'Libis - About Block'; // @translate
    }
    ...
    public function form(PhpRenderer $view, SiteRepresentation $site,
        ...
        return $view->partial('common/block-layout/about-block-form', [
            'block' => $block,
        ]);
    }
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
    {
      ...
      return $view->partial('common/block-layout/about-block', [
        'block' => $block,
