<?php
namespace CollectionCardsBlock\Site\BlockLayout;
 ...
 */
class CollectionCardsBlock extends AbstractBlockLayout
{
    /**
    ...
    {
        return 'Libis - Collection cards'; // @translate
    }
    ...
    public function form(PhpRenderer $view, SiteRepresentation $site,
        ...
        return $view->partial('common/block-layout/collection-card-form', [
            'block' => $block,
        ]);
    }
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
    {
      ...
      return $view->partial('common/block-layout/collection-card', [
        'block' => $block,
