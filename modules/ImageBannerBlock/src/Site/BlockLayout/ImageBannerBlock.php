<?php
namespace ImageBannerBlock\Site\BlockLayout;
 ...
 */
class ImageBannerBlock extends AbstractBlockLayout
{
    /**
    ...
    {
        return 'Libis - Banner image block'; // @translate
    }
    ...
    public function form(PhpRenderer $view, SiteRepresentation $site,
        ...
        return $view->partial('common/block-layout/image-banner-block-form', [
            'block' => $block,
        ]);
    }
    ...
    public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
    {
      ...
      return $view->partial('common/block-layout/image-banner-block', [
        'block' => $block,
